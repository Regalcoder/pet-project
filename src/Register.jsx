...
const Register =() => {
  ...
  const IsValidate =()=>{ //boolean function to test if all enteries are supplied by the user
    let Isproceed = true;
  ...
  const handlesubmit =(e)=>{
    ...
    if (IsValidate()) { // this will use the isvalidate function to check if all enteries are supplied before running the handlesubmit function
    console.log(regobj);
    ...
    .then((response) => {
      ...
      navigate('/login');
      console.log('your registeration details has been recieved successfully...' )
  }).catch((err)=>{
              ...
              <div className='row'>
                ...
                <div className='col-lg-6'>
                  <div className='form-group'>
                    ...
                    <input type='tel' value={phone} onChange={e=> phoneChange(e.target.value)} className='form-control'/>
                  </div>
                </div>
                ...
                <div className='col-lg-12'>
                  <div className='form-group'>
                    <label>Address</label>
                    <textarea className='form-control' value={address} onChange={e=> addressChange(e.target.value)} placeholder="Enter your address" />
                  </div>
                </div>
